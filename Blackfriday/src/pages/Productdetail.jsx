...
import { useGetPokemonByIdQuery } from '../services/productApi'
import { Link, useParams } from 'react-router-dom'

const Productdetail = () => {

  const id = useParams()
  const {data} = useGetPokemonByIdQuery(id.id)
  console.log(id.id)
          ...
          <div class="row gx-5">
            <aside class="col-lg-6">
              <div class="border rounded-4 mb-3 d-flex justify-content-center">
                  ...
                  <img style={max} class="rounded-4 fit" src={data?.images} />
              ...
              <div class="ps-lg-3">
                ...
                <div class="row mb-4">
                  <div class="col-md-4 col-6">
                    ...
                    <select class="form-select border border-secondary" style={height}>
                      <option>Small</option>
                ...
                <Link to="/cart" class="btn btn-primary shadow-0"> <i class="me-1 fa fa-shopping-basket"></i> Add to cart </Link>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex mb-3">
                      <a href="#" class="me-3">
                        <img src="https://mdbcdn.b-cdn.net/img/bootstrap-ecommerce/items/8.webp" style={min} class="img-md img-thumbnail" />
                      </a>
                      <div class="info">
                    ...
                    <div class="d-flex mb-3">
                      <a href="#" class="me-3">
                        <img src="https://mdbcdn.b-cdn.net/img/bootstrap-ecommerce/items/9.webp" style={min} class="img-md img-thumbnail" />
                      </a>
                      <div class="info">
                        <a href="#" class="nav-link mb-1">
                    ...
                    <div class="d-flex mb-3">
                      <a href="#" class="me-3">
                        <img src="https://mdbcdn.b-cdn.net/img/bootstrap-ecommerce/items/10.webp" style={min} class="img-md img-thumbnail" />
                      </a>
                      <div class="info">
                    ...
                    <div class="d-flex">
                      <a href="#" class="me-3">
                        <img src="https://mdbcdn.b-cdn.net/img/bootstrap-ecommerce/items/11.webp" style={min} class="img-md img-thumbnail" />
                      </a>
                      <div class="info">
